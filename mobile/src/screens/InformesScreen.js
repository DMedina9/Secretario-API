...
import {
    ...
    ActivityIndicator, Alert, TextInput, Switch, Linking, Modal
} from 'react-native';
            ...
            >
                <View style={st.modalOverlayCentered}>
                    <View style={st.modalProgress}>
                        ...
                        <Text style={{ marginTop: 12, color: colors.text, fontWeight: 'bold', textAlign: 'center' }}>
                            {importMessage || 'Importando datos...'}
                        </Text>
